...
function createEditStyles(Colors: any) {
...
function createFitModalStyles(Colors: any) {
  return StyleSheet.create({
    overlay: { flex: 1, justifyContent: 'flex-end' },
    backdrop: { ...StyleSheet.absoluteFillObject, backgroundColor: 'rgba(0,0,0,0.6)' },
...
function createColStyles(Colors: any) {
  return StyleSheet.create({
...
function createMainStyles(Colors: any) {
  return StyleSheet.create({
    ...
    fitPreviewCard: { width: '47%', backgroundColor: Colors.cardSurface, borderRadius: Radius.lg, borderWidth: 1, borderColor: Colors.border, overflow: 'hidden', marginBottom: 12 },
    fitStackPreview: { aspectRatio: 1, backgroundColor: '#FFFFFF', borderTopLeftRadius: Radius.lg, borderTopRightRadius: Radius.lg, overflow: 'hidden' },
