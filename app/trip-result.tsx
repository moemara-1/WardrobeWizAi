...
export default function TripResultScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList<DayOutfit>
        ref={flatListRef} data={MOCK_DAYS} keyExtractor={(item) => item.label}
...
function createStyles(C: any) {
  return StyleSheet.create({
    ...
    tripMeta: { fontFamily: Typography.bodyFamilyBold, fontSize: 15, color: C.textPrimary, flex: 1 },
    weatherText: { fontFamily: Typography.bodyFamily, fontSize: 13, color: C.textSecondary, marginRight: 8 },
    ...
    outfitCat: { fontFamily: Typography.bodyFamily, fontSize: 12, color: C.textSecondary },
