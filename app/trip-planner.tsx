...
function createStyles(C: any) {
  return StyleSheet.create({
    ...
    cityDropdownItem: { flexDirection: 'row', alignItems: 'center', gap: 12, paddingHorizontal: 16, paddingVertical: 18, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: C.border },
    cityDropdownText: { fontFamily: Typography.bodyFamily, fontSize: 16, color: C.textPrimary },
