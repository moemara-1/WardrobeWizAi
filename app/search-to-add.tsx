...
const styles = StyleSheet.create({
  ...
  searchBar: { flexDirection: 'row', alignItems: 'center', marginHorizontal: 16, paddingHorizontal: 14, paddingVertical: 12, backgroundColor: Colors.cardSurface, borderRadius: Radius.input, gap: 10, marginBottom: 20, borderWidth: 1, borderColor: Colors.border },
  searchInput: { flex: 1, fontFamily: Typography.bodyFamily, fontSize: 15, color: Colors.textPrimary, padding: 0 },
  scrollContent: { paddingHorizontal: 16, paddingBottom: 40 },
  sectionTitle: { fontFamily: Typography.bodyFamilyBold, fontSize: 16, color: Colors.textPrimary, marginBottom: 16 },
  searchRow: { flexDirection: 'row', alignItems: 'center', gap: 8, paddingVertical: 14 },
  dash: { fontFamily: Typography.bodyFamily, fontSize: 16, color: Colors.textSecondary },
  searchTerm: { fontFamily: Typography.bodyFamily, fontSize: 16, color: Colors.textPrimary },
});
